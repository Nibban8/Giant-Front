		...
		return (
			<>
				<Grid verticalAlign='bottom' columns={2}>
					<Header as='h1' id='Titulo'>
						Ensambles a tu medida
					</Header>
					<Header as='h2' inverted id='subTitulo'>
						Arma tu PC al instante y recibe una cotización completamente
						<Header style={{ fontSize: '3rem' }} inverted id='gratis'>
							GRATIS
						</Header>
					</Header>
					<Button as={Link} primary size='huge' to={'/Ensamble'} id='boton'>
						PROBAR AHORA
